...
class MainScene extends Phaser.Scene {
    ...
    spawnEnemy() {
        ...
        enemy.play("enemy-move-left", true); // Animation deplacement
    ...
    moveHero() {
        // Play the “enemy-move-left” animation for each enemy in the group
        this.enemies.getChildren().forEach(enemy => {
            enemy.play("enemy-move-left", true); // Apply animation to every enemy
        });
